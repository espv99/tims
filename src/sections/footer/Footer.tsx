...
const navLinks = [
  ...
  { label: 'Consejo Estudiantil', href: '/consejo-estudiantil' },
];

const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#001b55] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <span className="text-[#d79b05] text-xs font-semibold ml-2 uppercase tracking-widest">ESPOCH</span>
            </div>
            <p className="text-blue-200 text-sm leading-relaxed">
              Ingeniería en Tecnologías de la Información — Escuela Superior Politécnica del Chimborazo, Sede Morona
              Santiago.
            </p>
            <div className="flex gap-3 mt-1">
              <a
                ...
                aria-label="Facebook"
                className="w-9 h-9 rounded-full border border-white/20 hover:border-[#d79b05] hover:bg-[#d79b05]/10 flex items-center justify-center transition-colors duration-200 cursor-pointer"
              >
          ...
          {/* Links */}
          <div>
            <h3 className="text-xs font-semibold text-[#d79b05] uppercase tracking-widest mb-4">Navegación</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-xs font-semibold text-[#d79b05] uppercase tracking-widest mb-4">Contacto</h3>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-5xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-blue-300 text-xs">
            © {new Date().getFullYear()} ESPOCH Sede Morona Santiago. Todos los derechos reservados.
          </p>
          <p className="text-blue-400 text-xs">Ingeniería en Tecnologías de la Información</p>
        </div>
      </div>
    </footer>
  );
